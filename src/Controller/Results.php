...
class Results extends Controller
{
    ...
    public function showExerciseResults(Exercise $exercise, SQLOperations $operations): Response
    {
        ...
        return $this->render(
            'exercises.management.results',
            ["exercise" => $exercise, "questions" => $questions, "fulfillments" => $fulfillments, "answers" => $answers]
        );
    }
    ...
    public function showExerciseResult(Exercise $exercise, Question $question, SQLOperations $operations): Response
    {
        ...
        return $this->render(
            'exercises.management.results-by-question',
            ["exercise" => $exercise, "question" => $question, "answers" => $answers]
        );
    }
}